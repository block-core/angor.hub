...
import { AngorMockApiUtils } from '@angor/lib/mock-api/mock-api.utils';
import {
    tags as tagsData,
    tasks as tasksData,
    ...
    registerHandlers(): void {
        ...
        this._angorMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newTag.id = AngorMockApiUtils.guid();
        ...
        // @ Tasks - GET
        // -----------------------------------------------------------------------------------------------------
        this._angorMockApiService.onGet('api/apps/tasks/all').reply(() => {
            // Clone the tasks
