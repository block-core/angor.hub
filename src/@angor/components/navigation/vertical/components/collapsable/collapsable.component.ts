...
@Component({
    selector: 'angor-vertical-navigation-collapsable-item',
    ...
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'angor-vertical-navigation-item-collapsed': this.isCollapsed,
            'angor-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._angorVerticalNavigationComponent.onCollapsableItemCollapsed
    ...
    collapse(): void {
        ...
        this._angorVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._angorVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
